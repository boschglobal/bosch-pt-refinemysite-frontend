...
(async () => {
    try {
        ...
        scanner({
            options: {
                ...options,
                'sonar.projectKey': 'csm.web.app',
                'sonar.projectName': 'csm.web.app',
                'sonar.projectVersion': version,
                'sonar.sourceEncoding': 'UTF-8',
                'sonar.sources': 'src/app',
                'sonar.eslint.reportPaths':'eslint-report.json',
                'sonar.typescript.lcov.reportPaths': 'coverage/lcov.info',
                'sonar.exclusions': '**/node_modules/**,**/*.spec.ts,**/*.mock.ts,**/*.test.component.ts,src/polyfills.ts,**/*.test.component.html,**/*.test.component.scss,**/*.animation.ts,**/pat-list.constant.ts,**/news-articles.constant.ts',
                'sonar.tests': 'src/app',
                'sonar.test.inclusions': '**/*spec.ts',
                'sonar.issue.ignore.multicriteria': 'r1,r2,r3,r4,r5,r6,r7',
                ...
                'sonar.issue.ignore.multicriteria.r5.ruleKey': 'css:S4670',
                'sonar.issue.ignore.multicriteria.r5.resourceKey': '**/*.scss',
                'sonar.issue.ignore.multicriteria.r6.ruleKey': 'Web:TableHeaderHasIdOrScopeCheck',
                'sonar.issue.ignore.multicriteria.r6.resourceKey': '**/*.html',
                'sonar.issue.ignore.multicriteria.r7.ruleKey': 'Web:S5256',
                'sonar.issue.ignore.multicriteria.r7.resourceKey': '**/*.html',
            }
        });
    } catch (err) {
        console.error(err);
