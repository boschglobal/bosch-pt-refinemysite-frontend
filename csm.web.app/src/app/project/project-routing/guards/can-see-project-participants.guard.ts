...
export class CanSeeProjectParticipantsGuard extends ProtectAccessGuard implements CanActivate {
    ...
    public canActivate(route: ActivatedRouteSnapshot, state: RouterStateSnapshot) {
        if (this._projectSliceService.hasAccessToProjectParticipants()) {
            return true;
        } else {
