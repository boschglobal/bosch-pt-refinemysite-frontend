...
import {ProjectRfvCrChartBarStackedComponent} from './project-rfv-cr-chart-bar-stacked.component';

describe('ProjectRfvCrChartBarStackedComponent', () => {
    let component: ProjectRfvCrChartBarStackedComponent;
    let fixture: ComponentFixture<ProjectRfvCrChartBarStackedComponent>;
    ...
    beforeEach(() => {
        fixture = TestBed.createComponent(ProjectRfvCrChartBarStackedComponent);
